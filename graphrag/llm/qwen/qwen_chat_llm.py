...
class QwenChatLLM(BaseLLM[CompletionInput, CompletionOutput]):
    """A Chat-based LLM for Qwen."""
    ...
    async def _execute_llm(
        ...
        completion = await self.client.create_chat_completion(messages=messages, **args)
