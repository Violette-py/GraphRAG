...
"""Utility functions for the Qwen API."""
...
def get_token_counter(config: QwenConfiguration) -> Callable[[str], int]:
...
def get_completion_cache_args(configuration: QwenConfiguration) -> dict:
...
def get_completion_llm_args(
    parameters: dict | None, configuration: QwenConfiguration
) -> dict:
